...
describe("getBotReply", () => {
  ...
  it("Path (starter, name , no) - When user inputs no, should pop up appropriate answer/quesion", () => {
    ...
    const expectedReply3 = "Righto name, would you like to have breakfast first thing in morning?";
  ...
  it("Path (starter, name, yes , yes) last question should respond with 'Snoozing in might not be the best option to do <username>. You have some work to do.' ", () => {
    ...
    const expectedReply4 = "Ahh must be a good feeling... Have a good sleep name";
    ...
    const botReply4 = getBotReply("yes");
    const expectedReply4 = "Great choice name, having a good breakfast is a good start to a morning.";
    ...
    const botReply4 = getBotReply("no");
    const expectedReply4 = "Alrighty name, let's get ready for the busy work ahead. Are you going to the gym today?";
    ...
    const expectedReply5 = "Great choice name, finishing a gym session early in the day sets you up for a productive day. Have a good day!";
    ...
    const expectedReply5 = "Good choice name, it’s important to have rest days (unless this the fifth time this week) Do you want to go back to bed name...";
    ...
    const expectedReply6 = "Sounds about right...Good choice nonetheless. Rest well name";
